...
from auxiliary_functions import get_stage_events, detect_edges

fDOM_raw_data = np.array(dm.read_in_timeseries('Data/converted_data/julian_format/fDOM_raw_10.1.2011-9.4.2020.csv',True))
stage_data = np.array(dm.read_in_timeseries('Data/converted_data/julian_format/stage_10.1.11-1.1.19.csv',True))
turb_data = np.array(dm.read_in_timeseries('Data/converted_data/julian_format/turbidity_raw_10.1.2011_9.4.2020.csv',True))
...
fDOM_raw_data = dp.delete_from_timeseries(fDOM_raw_data, 'Data/Misc/delete_date_ranges.txt')
