%Plot Runoff Events on a Base Hydrograph, included flagged events
...
function [h] = plotflaggedrunoffevent(runoffEvents, HY, hasTxt)
    ...
    for i = 1:nEvent
        ...
        plot(runoff(:, 1), runoff(:, 2), col, 'linewidth', 1.1); 
    ...
    ylim([0, ymax]);
    legend('streamflow', 'runoff event', 'onset/offset'); 
    hold off
